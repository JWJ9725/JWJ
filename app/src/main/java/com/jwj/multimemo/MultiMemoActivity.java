...
import com.jwj.common.CommACActivity;
import com.jwj.common.view.TitleBitmapButton;
import com.jwj.multimemo.db.MemoDatabase;
 ...
 * @date 2011-07-01
 */
public class MultiMemoActivity extends CommACActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		//외장 디스크 체크
		BasicInfo.checkStoragePath(this);
    	...
    	*/
		...
		new CheckPermission(this, permissions).checkDangerousPermissions();
	}
